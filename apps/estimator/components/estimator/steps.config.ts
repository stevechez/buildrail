...
/**
 * Step configs for the Instant Estimate wizard.
 *
 * Calculation model (additive across all answered steps):
 *   low  = Σ option.baseCost
 *   high = Σ option.baseCost × option.costMultiplier
 *
 * Spot-check ranges:
 *   Remodel  · Under 1k sqft · Standard  →  $50k – $75k   ✓
 *   Addition · 1k–2.5k sqft  · Mid-grade →  $118k – $174k ✓
 *   New Build · 2.5k–5k sqft · Premium   →  $255k – $390k ✓
 */
export const ESTIMATOR_STEPS: EstimationStep[] = [
  ...
  // Conditional: only shown when project type is Remodel
  {
    id: "remodel-scope",
    question: "Which spaces are being renovated? (select all that apply)",
    type: "checkbox",
